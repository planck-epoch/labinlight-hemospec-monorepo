      ...
      >
        ...
        <q-item-section class="col-xs-3 col-sm-2">
          <q-item-label class="text-grey-8">
            {{$formatFullDate(organization.updatedAt)}}
          </q-item-label>
        </q-item-section>

        <q-item-section class="col-xs-3 col-sm-2">
          <q-item-label class="text-grey-8">
            {{$formatFullDate(organization.createdAt)}}
          </q-item-label>
        </q-item-section>
        ...
        <q-item-section side class="col-xs-0 col-sm-2">
          <div class="text-grey-8 q-gutter-xs q-pr-sm">
            <q-btn
              ...
              round
              icon="delete"
              @click.native.prevent.stop="confirmDelete(organization.id)"
            />
            <q-btn
              class="gt-xs"
              size="12px"
...
<script>
  ...
  export default {
    ...
    mixins: [ paginationMixin('organization', 'id'), showMixin('organization') ],
    computed: {
      ...mapGetters({
