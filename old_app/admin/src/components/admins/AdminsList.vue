  ...
  <q-page class="q-pa-md">
    ...
    >
      ...
      >
        ...
        <q-item-section class="col-xs-3 col-sm-2">
          <q-item-label class="text-grey-8">
            {{ $formatFullDate(admin.createdAt) }}
          </q-item-label>
        </q-item-section>
        ...
        <q-item-section side class="col-xs-0 col-sm-2">
          <div class="text-grey-8 q-gutter-xs">
            <q-btn
              ...
              round
              icon="delete"
              @click.native.prevent.stop="confirmDelete(admin.id)"
            />
            <q-btn
              class="gt-xs"
              size="12px"
      ...
      <div class="q-pa-lg full-width row wrap justify-between items-center content-center">
        <div class="col-xs-12 col-sm-3 text-center flex ">
          <div>
...
<script>
  ...
  export default {
    name: 'AdminsList',
    mixins: [ paginationMixin('admin', 'email'), showMixin('admin') ],
    computed: {
      ...mapGetters({
        admins: 'admins/all'
      }),
