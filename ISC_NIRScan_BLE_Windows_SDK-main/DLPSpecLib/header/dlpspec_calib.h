...
// Library scan types: 0-127 reserved for future library expansion
    ...
    SW_875_SA = 15,
    SW_895_SA = 16,
    CALIB_SCAN_TYPES_MAX = SW_895_SA
...
DLPSPEC_ERR_CODE dlpspec_calib_getFWHM(const double *values, const int num_values, const int peak_location, double *peak_height, double * fwhm);
